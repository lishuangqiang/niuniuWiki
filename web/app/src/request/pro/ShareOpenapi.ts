...
import {
  ...
  NiuniuWikiContractProApiShareV1CASCallbackResp,
  NiuniuWikiContractProApiShareV1DingtalkCallbackResp,
  NiuniuWikiContractProApiShareV1FeishuCallbackResp,
  NiuniuWikiContractProApiShareV1GitHubCallbackResp,
  NiuniuWikiContractProApiShareV1OAuthCallbackResp,
  NiuniuWikiContractProApiShareV1WecomCallbackResp,
} from "./types";
 ...
 * @response `200` `(DomainPWResponse & {
    data?: NiuniuWikiContractProApiShareV1CASCallbackResp,
 ...
 * @response `200` `(DomainPWResponse & {
    data?: NiuniuWikiContractProApiShareV1DingtalkCallbackResp,
 ...
 * @response `200` `(DomainPWResponse & {
    data?: NiuniuWikiContractProApiShareV1FeishuCallbackResp,
 ...
 * @response `200` `(DomainPWResponse & {
    data?: NiuniuWikiContractProApiShareV1GitHubCallbackResp,
 ...
 * @response `200` `(DomainPWResponse & {
    data?: NiuniuWikiContractProApiShareV1OAuthCallbackResp,
 ...
 * @response `200` `(DomainPWResponse & {
    data?: NiuniuWikiContractProApiShareV1WecomCallbackResp,

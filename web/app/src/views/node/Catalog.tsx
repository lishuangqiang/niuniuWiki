...
import { IconMulu } from '@niuniu-wiki/icons';
  ...
  return (
    <Stack
      ...
      sx={{
        ...
        p: catalogShow ? 1.5 : 0,
        bgcolor: catalogShow ? 'background.paper' : 'transparent',
        borderRadius: '22px',
        border: catalogShow ? '1px solid' : 'none',
        borderColor: 'divider',
        boxShadow: catalogShow ? '0 18px 60px rgba(0, 0, 0, 0.055)' : 'none',
        ...(!catalogShow &&
          docWidth === 'full' && {
            width: 24,
          }),

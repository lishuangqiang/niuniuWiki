...
import {
  ...
  NiuniuWikiContractApiNodeV1NodeListGroupNavResp,
} from '@/request/types';
...
export const DEFAULT_DATA = {
  ...
  nav_doc: {
    title: '目录卡片',
    nodes: [] as (NiuniuWikiContractApiNodeV1NodeListGroupNavResp & {
      id: string;
    })[],
  },
  simple_doc: {
...
export const COMPONENTS_MAP = {
  header: {
    name: 'header',
    title: '顶部导航',
    component: lazy(() => import('@niuniu-wiki/ui/welcomeHeader')),
  ...
  banner: {
    name: 'banner',
    title: '欢迎组件',
    component: lazy(() => import('@niuniu-wiki/ui/banner')),
  ...
  basic_doc: {
    ...
    component: lazy(() => import('@niuniu-wiki/ui/basicDoc')),
  ...
  dir_doc: {
    ...
    component: lazy(() => import('@niuniu-wiki/ui/dirDoc')),
  ...
  nav_doc: {
    ...
    title: '目录卡片',
    icon: IconMulushu,
    component: lazy(() => import('@niuniu-wiki/ui/navDoc')),
  ...
  simple_doc: {
    ...
    component: lazy(() => import('@niuniu-wiki/ui/simpleDoc')),
  ...
  carousel: {
    ...
    title: '轮播图',
    icon: IconLunbotu,
    component: lazy(() => import('@niuniu-wiki/ui/carousel')),
  ...
  faq: {
    ...
    title: '链接组',
    icon: IconLianjiezu1,
    component: lazy(() => import('@niuniu-wiki/ui/faq')),
  ...
  footer: {
    name: 'footer',
    title: '底部导航',
    component: lazy(() => import('@niuniu-wiki/ui/welcomeFooter')),
  ...
  text: {
    ...
    title: '标题',
    icon: IconDanwenzi,
    component: lazy(() => import('@niuniu-wiki/ui/text')),
  ...
  case: {
    ...
    title: '案例卡片',
    icon: IconKehuanli,
    component: lazy(() => import('@niuniu-wiki/ui/case')),
  ...
  metrics: {
    ...
    component: lazy(() => import('@niuniu-wiki/ui/metrics')),
  ...
  feature: {
    ...
    title: '产品特性',
    icon: IconTexing,
    component: lazy(() => import('@niuniu-wiki/ui/feature')),
  ...
  img_text: {
    ...
    title: '左图右字',
    icon: IconZuotuyouzi,
    component: lazy(() => import('@niuniu-wiki/ui/imgText')),
  ...
  comment: {
    ...
    component: lazy(() => import('@niuniu-wiki/ui/comment')),
  ...
  block_grid: {
    ...
    title: '区块网格',
    icon: IconJiugongge,
    component: lazy(() => import('@niuniu-wiki/ui/blockGrid')),
  ...
  question: {
    ...
    component: lazy(() => import('@niuniu-wiki/ui/question')),

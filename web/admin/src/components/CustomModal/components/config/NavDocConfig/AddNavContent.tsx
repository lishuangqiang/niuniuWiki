...
import { IconXiajiantou } from '@niuniu-wiki/icons';
...
function normalizeNavGroupResponse(
  ...
  if (Array.isArray(res))
    return res as NiuniuWikiContractApiNodeV1NodeListGroupNavResp[];
  if (res && typeof res === 'object') {
    ...
    for (const key of ['list', 'data', 'groups', 'items']) {
      if (Array.isArray(obj[key]))
        return obj[
          key
        ] as NiuniuWikiContractApiNodeV1NodeListGroupNavResp[];
    }
  }
  return [];
}

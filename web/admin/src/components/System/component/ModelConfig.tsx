...
import {
  DomainSwitchModeReq,
  NiuniuWikiContractDomainModelListItem,
  NiuniuWikiContractDomainModelProvider,
} from '@/request/types';
...
interface ModelConfigProps {
  onCloseModal: () => void;
  chatModelData: NiuniuWikiContractDomainModelListItem | null;
  embeddingModelData: NiuniuWikiContractDomainModelListItem | null;
  rerankModelData: NiuniuWikiContractDomainModelListItem | null;
  analysisModelData: NiuniuWikiContractDomainModelListItem | null;
  analysisVLModelData: NiuniuWikiContractDomainModelListItem | null;
  getModelList: () => void;
        ...
        if (tempMode === 'auto' && autoConfigRef.current) {
          ...
          if (formData) {
            ...
            requestData.auto_mode_provider =
              NiuniuWikiContractDomainModelProvider.ModelProviderBaiZhiCloudModelStore;

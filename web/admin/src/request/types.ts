...
export enum NiuniuWikiContractDomainModelProvider {
...
export interface DomainConversationMessage {
  ...
  /** model */
  provider?: NiuniuWikiContractDomainModelProvider;
  /** stats */
  remote_ip?: string;
  role?: SchemaRoleType;
  total_tokens?: number;
...
export interface DomainCreateModelReq {
  ...
  base_url: string;
  model: string;
  parameters?: NiuniuWikiContractDomainModelParam;
  provider: NiuniuWikiContractDomainModelProvider;
...
export interface DomainModelModeSetting {
  ...
  /** 自动模式供应商 */
  auto_mode_provider?: NiuniuWikiContractDomainModelProvider;
  /** 自定义对话模型名称 */
  chat_model?: string;
  /** 手动模式下嵌入模型是否更新 */
...
export interface NiuniuWikiContractApiAuthV1AuthGetResp {
  auths?: V1AuthItem[];
  client_id?: string;
...
export interface NiuniuWikiContractApiNodeV1NodeListGroupNavResp {
  count?: number;
  is_released?: boolean;
...
export interface NiuniuWikiContractApiShareV1AuthGetResp {
  auth_type?: ConstsAuthType;
  license_edition?: ConstsLicenseEdition;
  source_type?: ConstsSourceType;
}

export type NiuniuWikiContractApiShareV1GitHubCallbackResp = Record<
  string,
  any
>;

export interface NiuniuWikiContractDomainCheckModelReq {
  api_header?: string;
  api_key?: string;
  /** for azure openai */
  api_version?: string;
...
export interface NiuniuWikiContractDomainCheckModelResp {
  content?: string;
  error?: string;
}

export interface NiuniuWikiContractDomainModelListItem {
  api_header?: string;
  api_key?: string;
  /** for azure openai */
  api_version?: string;
...
export interface NiuniuWikiContractDomainModelParam {

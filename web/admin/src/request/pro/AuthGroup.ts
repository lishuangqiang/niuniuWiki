...
import {
  ...
  NiuniuWikiContractProApiAuthV1AuthGroupCreateReq,
  NiuniuWikiContractProApiAuthV1AuthGroupCreateResp,
  NiuniuWikiContractProApiAuthV1AuthGroupDetailResp,
  NiuniuWikiContractProApiAuthV1AuthGroupListResp,
  NiuniuWikiContractProApiAuthV1AuthGroupMoveReq,
  NiuniuWikiContractProApiAuthV1AuthGroupTreeResp,
  NiuniuWikiContractProApiAuthV1AuthGroupUpdateReq,
} from "./types";
 ...
 * @response `200` `(DomainResponse & {
    data?: NiuniuWikiContractProApiAuthV1AuthGroupCreateResp,

})` OK
 */

export const postApiProV1AuthGroupCreate = (
  param: NiuniuWikiContractProApiAuthV1AuthGroupCreateReq,
 ...
 * @secure
 * @response `200` `(DomainResponse & {
    data?: NiuniuWikiContractProApiAuthV1AuthGroupDetailResp,
 ...
 * @secure
 * @response `200` `(DomainResponse & {
    data?: NiuniuWikiContractProApiAuthV1AuthGroupListResp,
...
export const patchApiProV1AuthGroupMove = (
  param: NiuniuWikiContractProApiAuthV1AuthGroupMoveReq,
  params: RequestParams = {},
) =>
  httpRequest<DomainResponse>({
 ...
 * @secure
 * @response `200` `(DomainResponse & {
    data?: NiuniuWikiContractProApiAuthV1AuthGroupTreeResp,
...
export const patchApiProV1AuthGroupUpdate = (
  param: NiuniuWikiContractProApiAuthV1AuthGroupUpdateReq,
  params: RequestParams = {},
) =>
  httpRequest<DomainResponse>({

...
import {
  ...
  NiuniuWikiContractProApiTokenV1APITokenListItem,
  NiuniuWikiContractProApiTokenV1CreateAPITokenReq,
  NiuniuWikiContractProApiTokenV1UpdateAPITokenReq,
} from "./types";
...
export const postApiProV1TokenCreate = (
  param: NiuniuWikiContractProApiTokenV1CreateAPITokenReq,
 ...
 * @response `200` `(DomainPWResponse & {
    data?: (NiuniuWikiContractProApiTokenV1APITokenListItem)[],
...
export const patchApiProV1TokenUpdate = (
  request: NiuniuWikiContractProApiTokenV1UpdateAPITokenReq,
  params: RequestParams = {},
) =>
  httpRequest<DomainPWResponse>({

...
import {
  ...
  NiuniuWikiContractDomainCheckModelReq,
  NiuniuWikiContractDomainCheckModelResp,
 ...
 * @response `200` `(DomainResponse & {
    data?: NiuniuWikiContractDomainCheckModelResp,

})` OK
 */

export const postApiV1ModelCheck = (
  model: NiuniuWikiContractDomainCheckModelReq,
  params: RequestParams = {},
) =>
  httpRequest<
    DomainResponse & {
 ...
 * @response `200` `(DomainPWResponse & {
    data?: NiuniuWikiContractDomainModelListItem,

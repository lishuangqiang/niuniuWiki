...
const ALL_FEATURE_PERMISSIONS = Object.values(ConstsLicenseEdition).filter(
  value => typeof value === 'number',
) as ConstsLicenseEdition[];

// 兼容历史组件的权限参数；牛牛 Wiki 不再按版本区分功能。
export const PROFESSION_VERSION_PERMISSION = ALL_FEATURE_PERMISSIONS;
export const BUSINESS_VERSION_PERMISSION = ALL_FEATURE_PERMISSIONS;
export const ENTERPRISE_VERSION_PERMISSION = ALL_FEATURE_PERMISSIONS;

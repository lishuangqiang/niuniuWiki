...
import type { NiuniuWikiContractProApiContributeV1ContributeItem } from '@/request/pro/types';
import {
...
import { IconWenjian } from '@niuniu-wiki/icons';
import dayjs from 'dayjs';
import { useEffect, useState } from 'react';

type ContributePreviewModalProps = {
  open: boolean;
  row: NiuniuWikiContractProApiContributeV1ContributeItem | null;
  onClose: () => void;
  onAccept: () => void;
  onReject: () => void;
};
...
export default function ContributePreviewModal(
  ...
  const [data, setData] =
    useState<NiuniuWikiContractProApiContributeV1ContributeDetailResp | null>(
      null,
    );

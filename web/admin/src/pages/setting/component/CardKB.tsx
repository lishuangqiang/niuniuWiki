...
import { IconIcon_tool_close, IconTianjiachengyuan } from '@niuniu-wiki/icons';
import { IconFuzhi } from '@niuniu-wiki/icons';
...
type ApiTokenPermission =
  NiuniuWikiContractProApiTokenV1CreateAPITokenReq['permission'];

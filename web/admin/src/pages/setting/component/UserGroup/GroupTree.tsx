...
import {
  NiuniuWikiContractProApiAuthV1AuthGroupTreeItem,
  ConstsSourceType,
} from '@/request/pro/types';
import { useAppSelector } from '@/store';
import { Modal, Table } from '@ctzhian/ui';
import { ColumnType } from '@ctzhian/ui/dist/Table';
import { IconGengduo, IconYonghuwenjianjia } from '@niuniu-wiki/icons';
...
export interface GroupTreeProps {
  data: NiuniuWikiContractProApiAuthV1AuthGroupTreeItem[];
  onDelete?: (id: number) => void;
  onClickMembers: (
    item: NiuniuWikiContractProApiAuthV1AuthGroupTreeItem,
  ) => void;
  onMove?: (args: {
    id: number;
    newParentId?: number;
                  ...
                  <Box
                    ...
                    onClick={e => {
                      ...
                      if (item && onClickMembers)
                        onClickMembers(
                          item as NiuniuWikiContractProApiAuthV1AuthGroupTreeItem,
                        );
                    }}
                  >
                    共 {item?.count || 0} 个成员
    ...
    >
      ...
      <DndContext>
        ...
        <ActionsMenu
          ...
          onAdd={() => {
            onEdit?.(
              menuItem as NiuniuWikiContractProApiAuthV1AuthGroupTreeItem,
              'add',
            );
          }}
          onEdit={() => {

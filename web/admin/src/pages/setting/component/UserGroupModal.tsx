...
import {
  NiuniuWikiContractProApiAuthV1AuthGroupListItem,
  NiuniuWikiContractProApiAuthV1AuthItem,
} from '@/request/pro/types';

interface UserGroupModalProps {
  data?: NiuniuWikiContractProApiAuthV1AuthGroupListItem;
  open: boolean;
  onCancel: () => void;
  onOk: () => void;
  userList: NiuniuWikiContractProApiAuthV1AuthItem[];
  type: 'add' | 'edit';
}
...
const UserGroupModal = ({
  ...
  const columns: ColumnType<NiuniuWikiContractProApiAuthV1AuthItem>[] = [
    {
      title: (

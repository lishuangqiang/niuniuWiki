...
import { NiuniuWikiContractProApiAuthV1AuthGroupListItem } from '@/request/pro/types';
import {
...
import { IconShuaxin } from '@niuniu-wiki/icons';
...
const DocPropertiesModal = ({
  ...
  const {
    ...
    defaultValues: {
      ...
      summary: '',
      answerable_groups:
        [] as NiuniuWikiContractProApiAuthV1AuthGroupListItem[],
      visitable_groups:
        [] as NiuniuWikiContractProApiAuthV1AuthGroupListItem[],
      visible_groups:
        [] as NiuniuWikiContractProApiAuthV1AuthGroupListItem[],
